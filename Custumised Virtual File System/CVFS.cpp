...
void man(char *name)
{
    ...
    {
        printf("Description : Used to opened existing file\n");
...
int fstat_file(int fd)
{
    ...
    printf("\n______Statistical Information about file_________\n");
    printf("File name : %s\n",temp->FileName);
    ...
    while(1)
    {
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret == -1)
                    printf("ERROR : Incorrect paramethers\n");
                if(ret == -2)
        ...
        else if(count == 4)
        {
            if(strcmp(command[0],"lseek") == 0)
            {
                ...
                if(fd == -1)
                {
                    printf("Error : Incorrect paramether\n");
                    continue;
                }
